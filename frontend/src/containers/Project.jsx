...
export default function Project({ inView, setInView }) {
  ...
  function handlePrev() {
    if (project.id !== projects[0].id) {
      ...
      navigate(`/projects/${_.kebabCase(res[0].name)}`, {
        state: {
          project: res[0],
        },
      });
  ...
  return (
    <motion.div
      ...
      exit="exit"
      // variants={fadeIn}
      style={{ backgroundColor: project?.attributes?.background }}
    >
          ...
          >
            <div className="flex flex-col w-full items-start relative">
              <motion.h1
                ...
                style={{ color: project?.attributes?.color }}
                initial={{
                  y: 20,
                  opacity: 0,
                }}
              ...
              <div className="flex flex-row gap-x-4 mt-6 w-full">
                {projects.attributes?.map((item, i) => (
                  <motion.img
            ...
            <div
              ...
              style={{ outlineColor: project?.attributes?.color }}
            >
              <motion.img
      ...
      <svg
        ...
        style={{ stroke: project?.attributes?.color }}
      >
        <motion.path
