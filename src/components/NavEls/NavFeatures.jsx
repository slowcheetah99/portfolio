...
export default function NavFeatures({ project }) {
  ...
  return (
    <div className="w-full h-[80svh] relative">
      ...
      <div className="w-full h-[11.5%] flex gap-x-8 justify-center items-center xl:items-end md:justify-end pt-0 lg:pt-6 md:pr-32 z-50 relative bg-white">
